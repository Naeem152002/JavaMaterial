...
public class MyController {
    ...
    String registerUser(User dto,Model model) {
    	...
    	return "login";
    		...
    		model.addAttribute("msg", "Doest not Register!! Error");
        	return "register";
    	}
    }
    	@PostMapping("/doLogin")
    	String loginUser(User dto,Model model,HttpServletRequest request) {
    		...
    		if(check!=null) {
    			...
    			model.addAttribute("msg", "Doest not Login!! Error");
    			return "login";
    		}
    	 ...
    	 @GetMapping("/edit")
    	 String getUsersById(@RequestParam("id") int id,Model model) {
     	...
     	String updateUser(User dto,Model model) {
     		...
     		if(check) {
     			...
     			model.addAttribute("msg", "Doest not Updated!! Error");
     			model.addAttribute("users",  userService.getAllUsers());
     			return "view";
     		}
    	 }
     		...
     		String deleteUser(@RequestParam("id") int id,Model model) {
     			...
     			if(check) {
     				...
     				model.addAttribute("msg", "Doest not Deleted!! Error");
     				model.addAttribute("users",  userService.getAllUsers());
     				return "view";
     			}
