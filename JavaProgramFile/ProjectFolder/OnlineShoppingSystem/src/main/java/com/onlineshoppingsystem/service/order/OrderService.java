...
import com.onlineshoppingsystem.enums.OrderStatus;
...
import com.onlineshoppingsystem.model.OrderItem;
import com.onlineshoppingsystem.model.Product;
import com.onlineshoppingsystem.repository.OrderRepository;
import com.onlineshoppingsystem.repository.ProductRepository;
import com.onlineshoppingsystem.service.cart.CartService;
...
public class OrderService implements IOrderService {
    ...
    public OrderDto getOrder(Long orderId) {
        return orderRepository.findById(orderId)
                ...
                .orElseThrow(() -> new ResourceNotFoundException("Order not found",null,null));
    }
