...
public class PostController {
	...
	@GetMapping("/")
	public ResponseEntity<PostResponse> getAllPost(@RequestParam (defaultValue=AppConstants.PAGE_NUMBER,required=false)int pageNumber,
	...
	public ResponseEntity<List<PostDto>>getPostByCatainingTitle(@PathVariable String keyword){
		return ResponseEntity.ok(this.postService.searchPosts(keyword));
	}
	@PostMapping("/image/upload/{postId}")
	public ResponseEntity<PostDto>uploadPost(@RequestParam MultipartFile image,@PathVariable int postId) throws IOException{
